`#programming-fundamentals` `#data-structures` `#assembler-school` `#master-in-software-development`

# Assembler School: Programming Fundamentals - Data Structures II <!-- omit in toc -->

With these exercises pill you'll learn how to use common methods in strings, arrays, objects...
