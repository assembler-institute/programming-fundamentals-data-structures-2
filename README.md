...
# Assembler Institute: Programming Fundamentals - Data structures II <!-- omit in toc -->
...
```bash
$ git clone https://github.com/assembler-institute/programming-fundamentals-data-structures-2.git
```
